-- Migration: Fix similarity search functions to use 384-dimensional vectors
-- The Hugging Face ViT model produces 384-dimensional embeddings
...
DROP FUNCTION IF EXISTS search_similar_found_items(vector(384), float, int);
...
DROP FUNCTION IF EXISTS search_similar_lost_items(vector(384), float, int);
